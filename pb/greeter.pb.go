...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\n" +
	"SayNamaste\x12\x15.greeter.HelloRequest\x1a\x13.greeter.HelloReplyB\x06Z\x04./pbb\x06proto3"
...
var file_proto_greeter_proto_depIdxs = []int32{
	...
	0, // 1: greeter.Greeter.SayNamaste:input_type -> greeter.HelloRequest
	1, // 2: greeter.Greeter.SayHello:output_type -> greeter.HelloReply
	1, // 3: greeter.Greeter.SayNamaste:output_type -> greeter.HelloReply
